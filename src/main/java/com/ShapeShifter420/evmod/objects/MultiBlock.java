...
import javax.annotation.Nonnull;
    ...
    public abstract class MultiBlock extends BlockInventoryTinkers {
        ...
        protected TileMultiblock<?> getTile(IBlockReader world, BlockPos pos) {
        ...
        @Override
        public BlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer, Hand hand) {
            // set rotation
